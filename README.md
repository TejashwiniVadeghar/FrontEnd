...
ID names cannot have spaces. If the ID name contains multiple words then use dashes between the words.
# Classes: 
Classes are used to group elements for styling and behavior. Unlike IDs, we can reuse the same class name throughout the HTML document. The class value can also have spaces.
